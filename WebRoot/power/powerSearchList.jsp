...
<form name="form2" method="post" action="power!delete.action" onsubmit="return befSubmit();">
<div id="table">
<table id="ec_table">
...
<td><a href="power!readyUpdate?pageNum=${power.id }">edit</a></td>
</tr>
</c:forEach>
</tbody>
<tfoot>
<tr>
         ...
         <ul>                            <li><a href="power!advance?pageNum=1">首页</a></li>
                            <li><a href="power!advance?pageNum=${list.previous}">前页</a></li>
                            <li><a href="power!advance?pageNum=${list.next }">后页</a></li>
                            <li><a href="power!advance?pageNum=${list.last }">末页</a></li>              
                            <li><span>转到</span>
                            <select name="pagenumber" id="pagenumber" onchange="powersearch();">
                                  <c:forEach begin="1" end="${list.totalPage }" step="1" var="item">                        
